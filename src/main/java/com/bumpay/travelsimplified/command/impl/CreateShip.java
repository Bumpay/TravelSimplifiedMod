...
public class CreateShip {
    ...
    public static int createShip(CommandSource source, String shipName, String portName, BlockPos pos1, BlockPos pos2, Direction isFacing) throws CommandSyntaxException {
        ...
        Ship ship = new Ship(shipName, source.asPlayer().getUniqueID(), port, template, isFacing);
